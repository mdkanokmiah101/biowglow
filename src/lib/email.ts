...
/**
 * Send order notification to bioglow.bd@gmail.com via SMTP relay
 * Uses mdkanokmiah232@gmail.com as the sender (app password auth)
 */
export async function sendOrderEmail(data: OrderData): Promise<void> {
  ...
  const toEmail = "bioglow.bd@gmail.com";
...
<body>
<div class="container">
<div class="header"><h1>🛒 নতুন অর্ডার</h1><p style="margin:4px 0 0;opacity:0.9">BioGlow Landing Page</p></div>
<div class="body">
...
<div class="footer">BioGlow — 4 in 1 স্কিন গ্লো কম্বো</div>
</div>
</body>
</html>`;
